				...
				<section class="row">
					<div class="col-sm-12">
						<section class="row">
							<div class="col-md-12 col-lg-12">
								  <h4 class="text-upper col-md-offset-6" style="Color:#7376df"><center><b>Candidates Details Table</b></center></h4><br>
                   <form class="subscription-form">
                    ...
                    <th> Name   </th>
                     ...
                     ResultSet rs=st.executeQuery("select * from tbl_cand");
                     while(rs.next())
                     {
                    	 %>
                    	 <TR>
                    	<td><img alt="Profile Pic" class="img-circle" src="profilepic.jsp?id=<%=rs.getInt(1) %>"  width="100px" height="80px"/></td>
                    	 ...
                    	 <th><a href="CandidateStatusController?id=<%=rs.getInt(1)%>&status=<%=rs.getString(9)%>"><%=rs.getString(9)%></a></th>
                    	 <td><a href="CandidateDeleteController?id=<%=rs.getInt(1)%>"><b>Delete</b></a></td>
                    	 </TR>
