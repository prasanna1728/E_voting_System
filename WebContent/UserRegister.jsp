		...
		<div class="row">
			<nav
				...
				<ul class="nav nav-pills flex-column sidebar-nav">
					...
					<li class="nav-item"><a class="nav-link" href="index.jsp"><em
							class="fa fa-calendar-o"></em>Home</a></li>
					<li class="nav-item"><a class="nav-link" href="AdminLogin.jsp"><em
							class="fa fa-bar-chart"></em>Admin</a></li>
					<li class="nav-item"><a class="nav-link" href="UserLogin.jsp"><em
							class="fa fa-hand-o-up"></em>Voter</a></li>
					<li class="nav-item"><a class="nav-link"
						href="CandidateLogin.jsp"><em class="fa fa-hand-o-up"></em>Candidate</a></li>
				</ul>
								...
								<div class="card mb-4">
									<div class="card-block">
										...
										<form class="form-horizontal"
											action=UserRegistrationController method="post"
											enctype="multipart/form-data">
											<fieldset>
												<!-- Name input-->
												<div class="form-group">
													<label class="col-12 control-label no-padding" for="name">Voter
														Name</label>

													<div class="col-12 no-padding">
														<input id="name" name="name" type="text"
															placeholder="Your Name" class="form-control"
															pattern="[A-Za-z ]+" title="Name must be alphabets only"
															required="required" title="Enter your Name (eg.xyz)">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-12 no-padding">
														<input id="mobileno" name="mobileno" type="text"
															...
															title="Enter your Mobile No" pattern="[7-9]{1}[0-9]{9}"
												...
												<div class="form-group">
													...
													<div class="col-12 no-padding">
														<input id="adhar" type="text" name="adhar" class="form-control" 
												...
												<div class="form-group">
													...
													<div class="col-12 no-padding">
														<input type="file" name="file"
															class="form-control"placeholder="Choose image"
															id="imgSel" required/>
													</div>
													<div class="form-group">
