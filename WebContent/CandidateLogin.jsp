					...
					<div class="col-sm-12">
						<section class="row">
							<div class="col-lg-offset-3 col-md-12 col-lg-9">
								<div class="jumbotron">
									<h1 class="mb-4"><center>Candidate Login</center></h1>
									<div class="card mb-4">
									<div class="card-block">
										...
										<form class="form-horizontal" action="CandidateLoginController" method="post">
											<fieldset>
												<!-- Name input-->
												<div class="form-group">
													...
													<div class="col-12 no-padding">
														<input id="email" name="email" type="text" placeholder="Your Email" class="form-control" required pattern=".*@gmail\.com" title="Enter your email (abc@gmail.com)">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-12 no-padding">
														<input id="password" name="password" type="password" placeholder="Your Password" class="form-control" required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" title="Password must contain at least 6 characters, including UPPER/lowercase and numbers.">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<a href="CandidateForgotPassword.jsp" class="btn btn-primary btn-md float-right">Forgot Password ?</a>
													<a href="CandidateRegister.jsp" class="btn btn-primary btn-md float-right">Registration</a>
