						...
						<div class="col-lg-offset-3 col-md-12 col-lg-9">
							<div class="jumbotron">
								<h1 class="mb-4" style="color: #6365d2">
									<center>Add Party Details</center>
								</h1>
								<div class="card mb-4">
									<div class="card-block">

										<form class="form-horizontal"
											action=AddPartyController method="post"
											enctype="multipart/form-data">
										<fieldset>
												<!-- Name input-->
												<div class="form-group">
													<label class="col-12 control-label no-padding" for="name">Party Name</label>
													
													<div class="col-12 no-padding">
														<input id="email" name="partyname" type="text" placeholder="Party Name" class="form-control">
													</div>
												</div>
											
											<div class="form-group">
													<label class="col-12 control-label no-padding" for="name">Party Founder</label>
													
													<div class="col-12 no-padding">
														<input id="founder" name="founder" type="text" placeholder="Party Founder" class="form-control">
													</div>
												</div>
												
												<div class="form-group">
													<label class="col-12 control-label no-padding" for="name">Party President </label>
													
													<div class="col-12 no-padding">
														<input id="pre" name="pre" type="text" placeholder="Party President " class="form-control">
													</div>
												</div>
												
												<!-- Email input-->
												<div class="form-group">
													<label class="col-12 control-label no-padding" for="email">Party Symbol</label>
													
													<div class="col-12 no-padding">
														<input id="imgSel" name="symbol" type="file" placeholder="Party Symbol" class="form-control" >
													</div>
													<div class="form-group">
