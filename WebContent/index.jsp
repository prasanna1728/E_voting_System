			...
			<main class="col-xs-12 col-sm-8 offset-sm-4 col-lg-9 offset-lg-3 col-xl-10 offset-xl-2 pt-3 pl-4">
				<header class="page-header row justify-center">
					<div class="col-md-6 col-lg-8" >
						<h1 class="text-center" style="color:#6365d2"></h1> 
					</div>
					...
					<div class="col-sm-12">
						<section class="row">
							<div class="col-md-12 col-lg-12">
								<div class="jumbotron">
									<h1 class="mb-4" style="color:#6365d2"><center><i>Smart E- Voting 
									System </i></center></h1>
									 <img src="images/vote7.JPG" height="600" width="950">
									<!--  <img src="images/gg.jpg" height="400" width="950"> -->
