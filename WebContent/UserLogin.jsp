					...
					<div class="col-sm-12">
						<section class="row">
							<div class="col-lg-offset-3 col-md-12 col-lg-9">
								<div class="jumbotron">
									<h1 class="mb-4"><center>Voter Login</center></h1>
									<div class="card mb-4">
										...
										<form class="form-horizontal" action="UserLoginController" method="post">
											<fieldset>
												...
												<div class="form-group">
													...
													<a href="UserForgotPassword.jsp" class="btn btn-primary btn-md float-right">Forgot Password ?</a>
													<a href="UserRegister.jsp" class="btn btn-primary btn-md float-right">Registration</a>
